...
@pytest.mark.parametrize(
    ("name", "expected_qc_ratio", "expected_diff", "expected_bg", "expected_fc"),
    [
        ("loose", 0.00, 0.20, 0.20, 1.5),
        ("default", 0.25, 0.25, 0.33, 2.0),
        ("strict", 0.50, 0.35, 0.50, 3.0),
    ],
)
def test_pipeline_profiles_bundle_fixed_step1_to_step3_with_named_step4(
    ...
    assert profile["step4"]["diff_threshold"] == pytest.approx(expected_diff)
