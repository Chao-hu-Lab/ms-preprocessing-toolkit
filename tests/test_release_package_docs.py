...
def test_build_workflow_copies_release_docs_into_packaged_zip() -> None:
    ...
    # build.yml now delegates to shared-workflows; verify correct delegation
    assert "Chao-hu-Lab/shared-workflows" in workflow
    assert "python-build.yml@main" in workflow
